...
MainMenuState::MainMenuState(GameManager*g):GameState(g)
{
	...
	buttons[0].first = new EmptyObject(g, Vector2D(gameManager->getDefaultWindowWidth() / 2 , gameManager->getDefaultWindowHeight() / 4*2), 160, 50, Resources::ButtonRestart);
	buttons[1].first = new EmptyObject(g, Vector2D(gameManager->getDefaultWindowWidth() / 2 , gameManager->getDefaultWindowHeight() / 4*2.5), 160, 50, Resources::ButtonRestart);
	buttons[2].first = new EmptyObject(g, Vector2D(gameManager->getDefaultWindowWidth() / 2 , gameManager->getDefaultWindowHeight() /4*3), 160, 50, Resources::ButtonRestart);
